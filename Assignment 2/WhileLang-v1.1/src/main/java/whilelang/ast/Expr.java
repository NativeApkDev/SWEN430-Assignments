...
public interface Expr extends SyntacticElement {
	 ...
	 *
	 */
	public static class ArrayAccess extends SyntacticElement.Impl implements
			Expr, LVal {
		/**
		 ...
		 * @param attributes
		 */
		public ArrayAccess(Expr source, Expr index, Attribute... attributes) {
			super(attributes);
			this.source = source;
			this.index = index;
		}
		 ...
		 * @param attributes
		 */
		public ArrayAccess(Expr src, Expr index, Collection<Attribute> attributes) {
			super(attributes);
			this.source = src;
			this.index = index;
		}
	...
	public static class RecordAccess extends SyntacticElement.Impl implements
		...
		public boolean equals(Object o) {
			...
			return Objects.equals(source, that.source) && Objects.equals(name, that.name);
		}
	}
	...
	/**
	 * Represents the dereferencing of a given reference.
	 *
	 * @author David j. Pearce
	 *
	 */
	public static class Dereference extends SyntacticElement.Impl implements Expr, LVal {
		/**
		 * The source expression being dereferenced.
		 */
		private final Expr source;

		public Dereference(Expr source, Attribute... attributes) {
			super(attributes);
			this.source = source;
		}

		/**
		 * Get the source expression of this dereference.
		 *
		 * @return
		 */
		public Expr getSource() {
	...
	/**
	 * Represents a field dereference operation.
	 *
	 * @author David j. Pearce
	 *
	 */
	public static class FieldDereference extends SyntacticElement.Impl implements Expr, LVal {
		/**
		 * The source expression being dereferenced.
		 */
		private final Expr source;
		 ...
		 * @param attributes
		 */
		public FieldDereference(Expr source, String name, Attribute... attributes) {
			super(attributes);
			this.source = source;
			this.name = name;
		}
	...
	/**
	 * Represents a cast from one expression type to another. For example, suppose
	 * <code>x</code> has type <code>int|null</code>. Then, we can cast
	 * <code>x</code> to have an integer type with <code>(int) x</code>
	 *
	 * @author David J. Pearce
	 *
	 */
	public static class Cast extends SyntacticElement.Impl implements Expr {
		/**
		 * Type the source expression is being casted to.
		 */
		private final Type type;
		/**
		 * The source expression being casted.
		 */
		private final Expr source;

		/**
		 * Construct a new cast for a given type and source expression.
		 *
		 * @param type       The target type of this cast.
		 * @param source     The source expression of this cast.
		 * @param attributes
		 */
		public Cast(Type type, Expr source,
				Attribute... attributes) {
			super(attributes);
			this.type = type;
			this.source = source;
		...
		/**
		 * Get the target type of this cast.
		 *
		 * @return
		 */
		public Type getType() {
		...
		/**
		 * Get the source expression of this cast.
		 * @return
		 */
		public Expr getSource() {
			return source;
	...
	/**
	 * Represents a runtime type test to check whether a give value is an instance
	 * of a given type (or not. For example, if <code>x</code> has type
	 * <code>int|null</code> then <code>x is int</code> can be used to determine
	 * whether <code>x</code> currently holds an integer value.
	 *
	 * @author David J. Pearce
	 *
	 */
	public static class Is extends SyntacticElement.Impl implements Expr {
		...
		public Is(Expr source, Type type,
				Attribute... attributes) {
			super(attributes);
			this.type = type;
			this.source = source;
