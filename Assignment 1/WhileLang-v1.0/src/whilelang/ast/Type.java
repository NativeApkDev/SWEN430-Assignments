...
public interface Type extends SyntacticElement {
	...
	// Creating RealNumber class which represents real numbers.
	// This class is inspired by the following source.
	// https://github.com/kianyewest/SWEN430/tree/master/swen430as1

	public static final class RealNumber extends SyntacticElement.Impl implements Type {

		/**
		 * Construct a new <code>real</code> type.
		 *
		 * @param attributes
		 */
		public RealNumber(Attribute... attributes) {
			super(attributes);
		}
